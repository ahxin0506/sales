...
<?php
   ...
   $sqlstr = "SELECT * FROM MEMBER WHERE MEMBER.mid='".$accid."' AND MEMBER.pid='".$accpd."';";
   $result = mysqli_query($link, $sqlstr);

   if( mysqli_num_rows($result)== 1)
   {
   echo "<center>";
   echo "<p class='font'>登入成功!<br>";
   echo '<a href="http://120.107.152.110/~a0418/HA/HA.html">回首頁</a></p><br>';}
   else
   {
   echo "<center>";
   echo "<p class='font'>帳密錯誤!<br>";
   echo '<a href="http://120.107.152.110/~a0418/HA/loginform.html">重新登入</a><br>';
   echo '<a href="http://120.107.152.110/~a0418/HA/registerform.html">註冊</a></p><br>';}
...
<div>  
  ...
  <h6 style="color: #3D3B39; font-size: 24px; text-align: center; font-style: oblique; font-family: Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, sans-serif;">聯絡資訊
                      <br />
    | 客服專線：0800-888-999 |    | 客服時間：(週一至五 9:00-21:00, 週六日9:00-18:00)| <br />
|信箱：HA.@haha.com| </h6>
  <p style="color: #3D3B39; font-size: 24px; text-align: center; font-style: oblique; font-family: Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, sans-serif;">&nbsp;</p>
</div>
